...
export const engineerAPI = {
  ...
  create: (data: any) => fetchAPI("/engineers/", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => fetchAPI(`/engineers/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const promptAPI = {
  ...
  create: (data: any) => fetchAPI("/prompts/", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => fetchAPI(`/prompts/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const prospectAPI = {
  ...
  create: (data: any) => fetchAPI("/prospects/", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => fetchAPI(`/prospects/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const actionAPI = {
  getAll: (filters?: { engineerId?: string; projectId?: string; event?: string }) => {
  ...
  create: (data: any) => fetchAPI("/actions/", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => fetchAPI(`/actions/${id}`, { method: "PUT", body: JSON.stringify(data) }),
